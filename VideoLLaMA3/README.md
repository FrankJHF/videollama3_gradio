...
```bash
python scripts/convert_hf_checkpoint.py --model_path /data/zhouting/models/VideoLLaMA3-2B --save_path /data/zhouting/models/videollama3_2b_local
```
...
```bash
# VideoLLaMA3 Stage 1
bash scripts/train/video_ft.sh
bash scripts/train/video_ft_II.sh

bash scripts/train/video_ft_2b.sh
bash scripts/train/video_ft_II_2b.sh
# VideoLLaMA3 Stage 2
