...
RUN_NAME=gptfix_2b_stageII_batch32_180f_1e_directly
...
torchrun --nnodes $WORLD_SIZE \
    ...
    --data_path /home/zhouting/SurveillanceVideoFireAnalysis/annotation_data/training_data/StageII/really_training/final_training/train_samples_1_relabel_by_gpt4_fixed_quotes.json \
